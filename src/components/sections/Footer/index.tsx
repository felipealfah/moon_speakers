...
const Footer = () => {
  return (
    <footer className="w-full bg-[#19191E] py-14">
      <div className="max-w-[1200px] mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="space-y-8">
            ...
            <ul className="space-y-6">
              ...
              <li>
                <Link href="/terms-services" className="text-white hover:text-gray-300 transition-colors">
                  Terms & Services
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/refund-policy" className="text-white hover:text-gray-300 transition-colors">
                  Refund Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-[#1F2937]">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-white/70">© 2025 Moon Speakers. All rights reserved.</p>
            <div className="flex gap-6">
              <a href="#" className="text-white/70 hover:text-white transition-colors">
                <svg width="10" height="16" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.5 1H7.5C6.57174 1 5.6815 1.36875 5.02513 2.02513C4.36875 2.6815 4 3.57174 4 4.5V6.5H2V9.5H4V15.5H7V9.5H9L9.5 6.5H7V4.5C7 4.23478 7.10536 3.98043 7.29289 3.79289C7.48043 3.60536 7.73478 3.5 8 3.5H9.5V1Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </a>
              <a href="#" className="text-white/70 hover:text-white transition-colors">
                <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15.5 1C14.8381 1.49667 14.1031 1.89667 13.3333 2.17333C12.9178 1.68667 12.3653 1.33667 11.7487 1.16667C11.1322 0.996667 10.4798 1.01333 9.87421 1.21333C9.26862 1.41333 8.73661 1.78667 8.34592 2.28667C7.95523 2.78667 7.72541 3.39333 7.68333 4.03333V4.7C6.46498 4.73333 5.26191 4.46667 4.17576 3.92667C3.08962 3.38667 2.15645 2.59333 1.45 1.61667C1.45 1.61667 -1.21667 7.61667 4.78333 10.2833C3.35855 11.2833 1.70834 11.8167 0 11.8333C5.99999 15.1667 13.3333 11.8333 13.3333 4C13.3328 3.81333 13.3157 3.62667 13.2833 3.44333C13.9756 2.75333 14.4593 1.91667 15.5 1Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </a>
              <a href="#" className="text-white/70 hover:text-white transition-colors">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M11.3333 1.33334H4.66667C2.82572 1.33334 1.33333 2.82573 1.33333 4.66667V11.3333C1.33333 13.1743 2.82572 14.6667 4.66667 14.6667H11.3333C13.1743 14.6667 14.6667 13.1743 14.6667 11.3333V4.66667C14.6667 2.82573 13.1743 1.33334 11.3333 1.33334Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M10.6667 7.58C10.7489 8.13008 10.6542 8.69209 10.3958 9.18251C10.1375 9.67293 9.72877 10.0696 9.23166 10.3133C8.73455 10.557 8.16886 10.6355 7.62063 10.5375C7.0724 10.4395 6.5715 10.1698 6.18563 9.7683C5.79977 9.36665 5.54282 8.85654 5.46026 8.30601C5.37771 7.75547 5.47318 7.19341 5.73146 6.70504C5.98973 6.21666 6.40305 5.82164 6.90399 5.57989C7.40493 5.33814 7.97017 5.26177 8.52 5.36C9.08187 5.46077 9.60158 5.72377 10.0008 6.12296C10.4 6.52215 10.663 7.04186 10.6667 7.58Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M11.6667 4.33334H11.6733" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </a>
              <a href="#" className="text-white/70 hover:text-white transition-colors">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.33333 4.66667C10.2616 4.66667 11.1518 5.0357 11.8082 5.69206C12.4646 6.34842 12.8333 7.23855 12.8333 8.16667V12.8333H10.5V8.16667C10.5 7.85725 10.3771 7.56051 10.1583 7.34172C9.93948 7.12293 9.64275 7 9.33333 7C9.02391 7 8.72718 7.12293 8.50839 7.34172C8.28959 7.56051 8.16667 7.85725 8.16667 8.16667V12.8333H5.83333V8.16667C5.83333 7.23855 6.20208 6.34842 6.85844 5.69206C7.5148 5.0357 8.40493 4.66667 9.33333 4.66667Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M3.5 5.25H1.16667V12.8333H3.5V5.25Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M2.33333 3.5C2.97767 3.5 3.5 2.97767 3.5 2.33333C3.5 1.689 2.97767 1.16667 2.33333 1.16667C1.689 1.16667 1.16667 1.689 1.16667 2.33333C1.16667 2.97767 1.689 3.5 2.33333 3.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </a>
            </div>
          </div>
